...
namespace Backend.Repository.impl
{
    public class UserRepositoryImpl : UserRepository
    {
        ...
        public async Task<User> Register(RegisterDTO dto, string hashedPassword)
        {
        ...
        public async Task<List<User>> GetUsers(string? email, int? status, int? roleId, int page, int pageSize)
        {
            IQueryable<User> query = _context.Users
                .AsNoTracking()
                .Include(x => x.Role);
